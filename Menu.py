...
def level_screen(screen):
    ...
    for n in range(len(Levels)):
        buttons.append(
            Button(75 + (n % 6) * 110, 100 + int(n / 6.0) * 110, 100, 100, grid_color, piece_color, piece_font,
                   str(n + 1), n))
    ...
    def display(screen):
        ...
        screen.blit(title_img, (
            800 / 2 - title_img.get_width() / 2, 600 / 2 - title_img.get_height() / 2 - 250))  # auto center text
